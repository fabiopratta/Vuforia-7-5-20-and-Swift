...
- (void) renderVideoBackground {
    ...
    Vuforia::Matrix44F vbProjectionMatrix = Vuforia::Tool::convert2GLMatrix(_currentRenderingPrimitives->getVideoBackgroundProjectionMatrix(_currentView));// UPDATE FABIO, Vuforia::COORDINATE_SYSTEM_CAMERA));
